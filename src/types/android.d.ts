  ...
  export namespace fitcom {
    export namespace fancywebview {
      export class AdvancedWebView {
        ...
        public constructor(
          param0: androidcontentContext,
          param1: co.fitcom.fancywebview.AdvancedWebViewListener
        );
        ...
        public setBuilder(
          builder: androidsupportcustomtabsCustomTabsIntentBuilder
        ): void;
        public setWebViewListener(
          param0: co.fitcom.fancywebview.AdvancedWebViewListener
        ): void;
        public setCustomTabsClient(
          param0: androidsupportcustomtabsCustomTabsClient
        ): void;
